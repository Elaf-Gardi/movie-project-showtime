    ...
    <nav className='p-4'>
       <form className="flex items-center ">   
        <div className="relative lg:w-1/4 w-full">
            ...
            <input type="search" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg  block w-full pl-10 p-2.5  dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white " placeholder="Search on movies..." required/>
