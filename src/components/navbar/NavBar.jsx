            ...
            >
             <svg
              ...
              <div className="group inline-block">
                ...
                <ul
                  className=" border rounded-sm transform scale-0 group-hover:scale-100  
  transition duration-150 ease-in-out origin-top min-w-32 top-full left-0 mt-1 w-32 hidden group-hover:block"
                >
