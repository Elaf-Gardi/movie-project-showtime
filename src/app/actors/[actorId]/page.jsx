...
const ActorInfo = async ({ params }) => {
  ...
  return (
    <div className="px-10 lg:pt-28 pt-8 pb-8 overflow-hidden bg-[#0c121d]">
      <div className="flex md:flex-row items-start flex-col md:gap-10 md:flex-1">
        ...
        <div className="flex md:flex-1 flex-col">
          <h1 className="font-Roboto font-extrabold lg:text-4xl text-xl text-darkRed md:tracking-wider mb-6">
            {actorInfo.name}
          </h1>
          <div>
            <div className="mb-6">
